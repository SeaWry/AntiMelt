...
The config is simple and easy to understand, no need to explain it really. 

There is no dependancy plugins or files, world guard and so forth should be fine. All that is happening
is the melt event is being cancled in a simple method. 